...
public class Maze {
    ...
    // Walls
    private static final int NORTH = 2; // 0010
    private static final int EAST = 1; // 0001
    ...
    private void explore(Cell parent, Cell adjacent, int wall) {
        ...
        if (verticiesVisited < verticies) {
            if (parent != null) {
                // Breakdown parent's wall
                // Breakdown child's wall
            }
        }
    ...
    public class Cell {
        ...
        private boolean visited; // Record if cell has been visited during pathfinding
        private int row;
        private int col;
